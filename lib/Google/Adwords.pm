...
This documentation refers to Google::Adwords version 1.12
 

=head1 API VERSION

Google::Adwords currently uses version 13 (v13) of the Adwords API. As such,
...
Copyright (c) 2006-2008 Rohan Almeida <rohan@almeida.in>. All rights
reserved.
